...
// adapted from `metadata-extractor` v2.21.0 `PhotoshopReader` to prevent OOM from reading large XMP
// as of `metadata-extractor` v2.21.0, there is no way to customize the Photoshop reader
