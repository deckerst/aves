...
object DngTags {
    ...
    const val DEFAULT_SCALE = 0xC61E
    const val DEFAULT_CROP_ORIGIN = 0xC61F
    const val DEFAULT_CROP_SIZE = 0xC620
    const val COLOR_MATRIX_1 = 0xC621
    const val COLOR_MATRIX_2 = 0xC622
    const val CAMERA_CALIBRATION_1 = 0xC623
    const val CAMERA_CALIBRATION_2 = 0xC624
    private const val REDUCTION_MATRIX_1 = 0xC625
    private const val REDUCTION_MATRIX_2 = 0xC626
    const val ANALOG_BALANCE = 0xC627
    const val AS_SHOT_NEUTRAL = 0xC628
    const val AS_SHOT_WHITE_XY = 0xC629
    ...
    const val FORWARD_MATRIX_1 = 0xC714
    const val FORWARD_MATRIX_2 = 0xC715
    ...
    const val COLOR_MATRIX_3 = 0xCD33
    const val FORWARD_MATRIX_3 = 0xCD34
