package com.shiv.albumic.model.provider
...
import com.shiv.albumic.MainActivity
import com.shiv.albumic.MainActivity.Companion.DELETE_SINGLE_PERMISSION_REQUEST
import com.shiv.albumic.glide.AvesAppGlideModule
...
import com.shiv.albumic.metadata.Metadata.TYPE_EXIF
import com.shiv.albumic.metadata.Metadata.TYPE_IPTC
import com.shiv.albumic.metadata.Metadata.TYPE_MP4
import com.shiv.albumic.metadata.Metadata.TYPE_XMP
import com.shiv.albumic.metadata.Mp4ParserHelper
import com.shiv.albumic.metadata.Mp4ParserHelper.updateLocation
import com.shiv.albumic.metadata.Mp4ParserHelper.updateRotation
import com.shiv.albumic.metadata.Mp4ParserHelper.updateXmp
import com.shiv.albumic.metadata.MultiPage
import com.shiv.albumic.metadata.PixyMetaHelper
import com.shiv.albumic.metadata.PixyMetaHelper.extendedXmpDocString
import com.shiv.albumic.metadata.PixyMetaHelper.xmpDocString
import com.shiv.albumic.metadata.metadataextractor.Helper
import com.shiv.albumic.metadata.xmp.GoogleXMP
import com.shiv.albumic.model.AvesEntry
import com.shiv.albumic.model.EntryFields
import com.shiv.albumic.model.ExifOrientationOp
import com.shiv.albumic.model.FieldMap
import com.shiv.albumic.model.NameConflictResolution
import com.shiv.albumic.model.NameConflictStrategy
import com.shiv.albumic.model.SourceEntry
...
import com.shiv.albumic.storage.apis.StorageApi
import com.shiv.albumic.utils.BitmapUtils
import com.shiv.albumic.utils.BmpWriter
import com.shiv.albumic.utils.FileUtils
import com.shiv.albumic.utils.FileUtils.copyFrom
import com.shiv.albumic.utils.FileUtils.copyTo
import com.shiv.albumic.utils.FileUtils.getFileSize
import com.shiv.albumic.utils.LogUtils
import com.shiv.albumic.utils.MimeTypes
import com.shiv.albumic.utils.MimeTypes.canEditExif
import com.shiv.albumic.utils.MimeTypes.canEditIptc
import com.shiv.albumic.utils.MimeTypes.canEditXmp
import com.shiv.albumic.utils.MimeTypes.canReadWithExifInterface
import com.shiv.albumic.utils.MimeTypes.canRemoveMetadata
import com.shiv.albumic.utils.MimeTypes.extensionFor
