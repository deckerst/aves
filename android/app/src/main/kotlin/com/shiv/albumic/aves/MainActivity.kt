...
import com.shiv.albumic.channel.calls.AnalysisHandler
import com.shiv.albumic.channel.calls.AppAdapterHandler
import com.shiv.albumic.channel.calls.AppProfileHandler
import com.shiv.albumic.channel.calls.Coresult.Companion.safe
import com.shiv.albumic.channel.calls.DebugHandler
import com.shiv.albumic.channel.calls.DeviceHandler
import com.shiv.albumic.channel.calls.EmbeddedDataHandler
import com.shiv.albumic.channel.calls.GeocodingHandler
import com.shiv.albumic.channel.calls.GlobalSearchHandler
import com.shiv.albumic.channel.calls.HomeWidgetHandler
import com.shiv.albumic.channel.calls.MediaEditHandler
...
import com.shiv.albumic.channel.calls.MetadataEditHandler
import com.shiv.albumic.channel.calls.MetadataFetchHandler
import com.shiv.albumic.channel.calls.SecurityHandler
import com.shiv.albumic.channel.calls.StorageHandler
import com.shiv.albumic.channel.calls.StoragePermissionHandler
import com.shiv.albumic.channel.calls.WallpaperHandler
import com.shiv.albumic.channel.calls.window.ActivityWindowHandler
import com.shiv.albumic.channel.calls.window.WindowHandler
import com.shiv.albumic.channel.streams.darttoplatform.ActivityResultStreamHandler
import com.shiv.albumic.channel.streams.darttoplatform.ImageByteStreamHandler
import com.shiv.albumic.channel.streams.darttoplatform.ImageOpStreamHandler
import com.shiv.albumic.channel.streams.darttoplatform.MediaStoreStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.AnalysisStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.IntentStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.MediaCommandStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.MediaStoreChangeStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.MessageStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.SettingsChangeStreamHandler
import com.shiv.albumic.channel.streams.platformtodart.WindowChangeStreamHandler
...
import com.shiv.albumic.utils.UriUtils.isGeoScheme
import com.shiv.albumic.utils.anyCauseIs
...
//        )
    ...
    override fun onDestroy() {
        ...
        try {
            ...
            // `Fatal Exception:`
            // `java.lang.RuntimeException: Unable to destroy activity {com.shiv.albumic/com.shiv.albumic.MainActivity}:`
