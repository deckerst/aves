...
void main() {
  test('Decimal degrees to DMS (sexagesimal)', () {
    ...
    expect(ExtraCoordinateFormat.toDMS(locale, l10n, const LatLng(-64.249391, -56.6556145)), ['64° 14′ 57.81″ S', '56° 39′ 20.21″ W']); // Marambio
    expect(ExtraCoordinateFormat.toDMS(locale, l10n, const LatLng(0, 0)), ['0° 0′ 0.00″ N', '0° 0′ 0.00″ E']);
    expect(ExtraCoordinateFormat.toDMS(locale, l10n, const LatLng(0, 0), minuteSecondPadding: true), ['0° 00′ 00.00″ N', '0° 00′ 00.00″ E']);
    expect(ExtraCoordinateFormat.toDMS(locale, l10n, const LatLng(0, 0), secondDecimals: 0), ['0° 0′ 0″ N', '0° 0′ 0″ E']);
    expect(ExtraCoordinateFormat.toDMS(locale, l10n, const LatLng(0, 0), secondDecimals: 4), ['0° 0′ 0.0000″ N', '0° 0′ 0.0000″ E']);
  });
  ...
  test('Decimal degrees to DDM', () {
    ...
    expect(ExtraCoordinateFormat.toDDM(locale, l10n, const LatLng(-64.249391, -56.6556145)), ['64° 14.9635′ S', '56° 39.3369′ W']); // Marambio
    expect(ExtraCoordinateFormat.toDDM(locale, l10n, const LatLng(0, 0)), ['0° 0.0000′ N', '0° 0.0000′ E']);
    expect(ExtraCoordinateFormat.toDDM(locale, l10n, const LatLng(0, 0), minutePadding: true), ['0° 00.0000′ N', '0° 00.0000′ E']);
    expect(ExtraCoordinateFormat.toDDM(locale, l10n, const LatLng(0, 0), minuteDecimals: 0), ['0° 0′ N', '0° 0′ E']);
    expect(ExtraCoordinateFormat.toDDM(locale, l10n, const LatLng(0, 0), minuteDecimals: 6), ['0° 0.000000′ N', '0° 0.000000′ E']);
  });
