...
class MapStyleDialog extends StatefulWidget {
  static const routeName = '/dialog/select_map_style';
...
class _MapStyleDialogState extends State<MapStyleDialog> {
  ...
  void _add() {
    // TODO TLAD [#1618] dialog to add style with name/url
  }

  void _edit(EntryMapStyle style) {
    // TODO TLAD [#1618] dialog to edit style with name/url
  }

  void _remove(EntryMapStyle style) {
